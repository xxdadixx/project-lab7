...
const CRUDTable = () => {
    ...
    // Function to handle successful insert
            ...
            <div>
                <main className='content-1'>
                    <div className='container'>
                                ...
                                <div className="modal-content">
                                    <div className="modal-header">
                                        <h1
                                            ...
                                            id="InsertFormLabel">เพิ่มข้อมูลนักศึกษา</h1>
                                        <button
                                            type="button"
                                            className="btn-close"
                                        ...
                                        <form
                                            ...
                                            <div className='mb-3'>
                                                ...
                                                <select
                                                    ...
                                                    >บริหารธุรกิจและศิลปศาสตร์</option>
                        ...
                        <div style={{ maxWidth: '1350', maxHeight: '600px', overflowX: 'auto', overflowY: 'auto' }}>
                                ...
                                <tbody>
                                    {Array.isArray(data) && data.map((item, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>{item.year}</td>
                                            <td>
                                                <Link to={'/crudclassedit/' + item._id} className='mx-1' style={{
                                                    textDecoration: 'none',
                                                    color: 'inherit'
                                                }}>
                                                    <FaEdit style={{
