...
function CRUDClassEdit() {
    ...
    useEffect(() => {
        // Create a new instance of the modal when the component mounts
    ...
    const validateDataFormat = () => {
        ...
        if (!data.firstname || !data.lastname || !nameRegex.test(data.firstname) || !nameRegex.test(data.lastname)) {
        ...
        if (data.faculty !== undefined && (typeof data.faculty !== 'string' || !data.faculty.trim())) {
            console.log('Faculty cannot be blank');
            return false;
        }
    
        if (data.branch !== undefined && (typeof data.branch !== 'string' || !data.branch.trim())) {
            console.log('Branch cannot be blank');
            return false;
        }
    
        if (data.year !== undefined && (typeof data.year !== 'string' || !data.year.trim())) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.put('http://localhost:5000/api/crudclass/' + params.id, data);
            console.log(res);
            handleSubmitSuccess();
            navigate('/crudclass');
        } catch (error) {
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        <h1
                            ...
                            id="UpdateFormLabel">แก้ไขข้อมูลนักศึกษา</h1>
                        <Link
                            to={'/crudclass'}
                            className="btn-close"
                        >
                        ...
                        >
                            ...
                            <div className='mb-3'>
                                <label
                                    ...
                                    className='form-label'>ชื่อ</label>
                                <input
                                    type='text'
                            ...
                            <div className='mb-3'>
                                <label
                                    ...
                                    className='form-label'>นามสกุล</label>
                                <input
                                    type='text'
                                    name='lastname'
                                    value={data.lastname}
                            ...
                            <div className='mb-3'>
                                <label
                                    ...
                                    className='form-label'>รหัสนักศึกษา</label>
                                <input
                                    type='text'
                                    name='studentID'
                            ...
                            <div className='mb-3'>
                                <label
                                    ...
                                    className='form-label'>คณะ</label>
                                <select
                            ...
                            <div className='mb-3'>
                                <label
                                    ...
                                    className='form-label'>สาขา</label>
                                <select
                                    className='form-select'
                                    id="validationBranch"
                                    name="branch"
                                ...
                                >
                                    <option
                                        disabled
                                        value="">เลือกสาขา</option>
                                    <option
                                        disabled
                                        className='bg-secondary-subtle'
                                        value="">บริหารธุรกิจและศิลปศาสตร์</option>
                                    ...
                                    <option
                                        disabled
                                        className='bg-secondary-subtle'
                                        value="">วิทยาศาสตร์และเทคโนโลยีการเกษตร</option>
                                    ...
                                    <option>วศ.บ. วิศวกรรมอิเล็กทรอนิกส์และระบบควบคุมอัตโนมัติ</option>
                                    ...
                                    <option
                                        disabled
                                        className='bg-secondary-subtle'
                                        value="">ศิลปกรรมและสถาปัตยกรรมศาสตร์</option>
                                    ...
                                    <option
                                        disabled
                                        className='bg-secondary-subtle'
                                        value="">วิทยาลัยเทคโนโลยีและสหวิทยาการ</option>
                            ...
                            <div className='mb-3'>
                                <label
                                    ...
                                    className='form-label'>ชั้นปี</label>
                                <select
                                    className='form-select'
                                    id="validationYear"
                                    name="year"
