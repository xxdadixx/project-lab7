              ...
              <div className="modal-dialog">
                <div className="modal-content">
                  <div className="modal-header">
                    <h1 className="modal-title fs-5" id="InsertFormLabel">
                      เพิ่มข้อมูลนักศึกษา
                    </h1>
                    <button
                      type="button"
                  ...
                  <div className="modal-body">
                    ...
                    >
                      ...
                      <div className="mb-3">
                        ...
                        <div className="invalid-feedback">กรุณาเลือกชั้นปี</div>
                      </div>
                      <div className="mb-3">
              ...
              <table className="table ">
                <thead>
                  <tr>
                    ...
                    <th scope="col">วันที่/เวลาที่เพิ่ม</th>
                    <th scope="col">วันที่/เวลาที่แก้ไข</th>
